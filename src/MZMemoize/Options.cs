...
namespace MZMemoize
{
    ...
    /// <summary>
    /// Option class: similar to the Nullable class with the exception that it does not have value type constraint on its TValue generic argument.
    /// </summary>
    ...
    /// <summary>
    ///  contains Option related helper functions
    /// </summary>
    public static class Option
    {
        /// <summary>
        /// Creates option which contains the given value
        /// </summary>
        ...
        /// <summary>
        /// Creates an option from the referecne type value; if the value is null, creates None, otherwise Some(referenceValue)
        /// </summary>

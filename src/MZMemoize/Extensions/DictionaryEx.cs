...
namespace MZMemoize.Extensions
{
    ...
    {
        /// <summary>
        /// <para>Finds value in the dictionary which corresponds to the given key. Calls the defaultGetter function and returns its result if the key isnt in the dictionary.</para>
        /// </summary>
        ...
        /// <summary>
        /// Returns the value for the given key; if not found, creates it using the value factory function, and adds it to the dictionary.
        /// </summary>
        ...
        /// <summary>
        /// returns value in the dictionary which corresponds to the given key, or TValue default value if not found.
        /// </summary>
        /// <typeparam name="TKey">dictionary key type</typeparam>
        /// <typeparam name="TValue">dictionary value type</typeparam>
        /// <param name="dictionary">dictionary to search for the given key</param>
        ...
        /// <summary>
        /// returns Some(value) if the given key is found in the dictionary, or None otherwise
        /// </summary>
        /// <typeparam name="TKey">dictionary key type</typeparam>
        /// <typeparam name="TValue">dictionary value type</typeparam>
        /// <param name="dictionary">dictionary to search for the given key</param>
        ...
        /// <summary>
        /// Adds the given key/value if the given ket isnt present in the dictionary; returns true if the key/value were added
        /// </summary>
        /// <typeparam name="TKey">key type</typeparam>
        /// <typeparam name="TValue">value type</typeparam>

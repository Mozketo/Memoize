...
namespace MZMemoize
{
    public static class FuncEx
    {
        ...
        /// <summary>
        /// implements the memoization pattern: the given function is called once only, its result gets cached.
        /// </summary>
    ...
    //        get
    //        {
    //            // to make sure that this storage is used when no other available
    //            return 1000;
    //        }
    //    }
    //}
    ...
    //        //update the local event time, so that this event can be seen locally right away
    //        er.LastTimeTriggered = value;
    //        //update the global event time
    ...
    //    }
    //    public string Name { get; internal set; }
    //    //this is to say that the event hasnt occured yet
    //    long _LastTimeTriggered = MinTime;
    //    /// <summary>
    //    ///  time of the last event, in the global context
    //    /// </summary>
    ...
    //    /// <summary>
    //    /// If specified then cache will be updated after certain time without external interventions
    //    /// </summary>
    //    public int? ForcedRefreshIntervalMin { get; internal set; }
    //    /// <summary>
    //    /// sets the time when the event was triggered last time, in global context
    //    /// </summary>
    ...
    //            // do not let the LastTimeTriggered going back in time, only forward
    ...
    //    }
    //    /// <summary>
    //    /// similar to the Trigger(), except it is a response to an event which came from the remote app instance, therefore we should react on it but not send it to the other apps again
    //    /// </summary>
    ...
    //    }
    //    /// <summary>
    //    /// fires the event in the current request context; the event is also propagated to the global context and to all remote app instances
    //    /// </summary>
    //    public void Trigger()
    //    {
    ...
    //    }
    //    /// <summary>
    //    ///  returns true if the event was fired since the given time, in current request context
    //    /// </summary>
